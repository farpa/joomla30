...
<?php else: ?>
	...
	<fieldset>
		...
		<p>
			...
			<br/>
			<a class="btn btn-danger" href="index.php?option=com_admintools&view=twofactor&task=resetkey&<?php echo JFactory::getSession()->getToken();?>=1">
...
<?php echo $this->panic ?>
		...
		<a class="btn btn-danger" href="index.php?option=com_admintools&view=twofactor&task=resetpanic&<?php echo JFactory::getSession()->getToken();?>=1">
